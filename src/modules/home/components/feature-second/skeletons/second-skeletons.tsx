...
export const CardSkeletonTwo = () => {
  return (
    <div className=" flex-1 absolute  mx-auto w-full h-full inset-x-0 rounded-t-3xl  p-2 gap-y-3 flex items-center justify-center mask-b-from-90% transform rotate-20 -skew-x-10 -skew-y-12 mask-t-from-90%   ">
      <Circle
        duration={3}
        className="size-20 flex items-center justify-center border-accent/50 shadow-md bg-background z-99"
      >
        <Image
          src={"/logo.svg"}
          width={20}
          height={20}
          alt="logo"
          className=" size-8 text-accent opacity-50 "
        />
      </Circle>
      <Circle
        duration={3}
        className=" size-42 border-accent/50 shadow-sm bg-secondary/90  relative"
      >
        <SiReact className=" absolute m-auto top-10 left-6" />
      </Circle>
      <Circle
        duration={5}
        className=" size-62 border-accent/40 shadow-md/10 bg-secondary/70 z-7"
      >
        <SiGooglesheets className=" absolute m-auto top-10 left-6" />
      </Circle>{" "}
      <Circle
        duration={13}
        className=" size-82 border-accent/20 shadow-md/10 bg-secondary/60 z-5"
      >
        <SiJenkins className=" absolute m-auto top-20 left-6" />
      </Circle>{" "}
      <Circle
        duration={20}
        className=" size-105 border-accent/10 shadow-sm bg-secondary/50 z-4"
      >
